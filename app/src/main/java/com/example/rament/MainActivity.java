...
public class MainActivity extends AppCompatActivity {
    ...
    private Notification getNotification(String content) {
        ...
        builder.setSmallIcon(R.drawable.tugas);
    ...
    private void populateListView() {
        try {
            ArrayList<ModelTugas> items = databaseHelper.getAllData();
            TugasAdapter itemsAdopter = new TugasAdapter(this, items);
    ...
    private void showAddDialog() {
        ...
        final View dialogView = inflater.inflate(R.layout.custom_daftar, null);
        ...
        dialogBuilder.setPositiveButton("Tambah", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int whichButton) {
                ...
                if (title.length() != 0) {
                    ...
                    toastMsg("Oops, Tidak Boleh Kosong!");
                }
            }
        });
